...
echo "== [$(date)] eval base vs n270 -> results/base-vs-tuned-lora-bf16"
python3 eval.py --model ckpt/n270/adapters --base $BASE --eval-set $EVAL_SET --out results/base-vs-tuned-lora-bf16 --judge-model "$JUDGE"
...
[ -e results/sweep/n270 ] || ln -s ../base-vs-tuned-lora-bf16 results/sweep/n270
python3 sweep.py --runs n270,n135,n67,n33 --base-results results/base-vs-tuned-lora-bf16 --judge-model "$JUDGE"
