...
|---|---|---|---|---|
| SLM-R1 | A well-prompted base model can't already do it reliably. | BLOCKED | results/full-30-combined/ANALYSIS.md:28, results/full-30-combined/ANALYSIS.md:57, results/full-30-combined/ANALYSIS.md:83 | IMPLEMENTED-UNVERIFIED |
...
| SLM-R11 | Before you write a line of fine-tuning code, prove (with numbers) that… | BLOCKED | results/full-30-combined/ANALYSIS.md:5, results/full-30-combined/ANALYSIS.md:28, results/full-30-combined/ANALYSIS.md:83 | IMPLEMENTED-UNVERIFIED |
...
| SLM-R16 | scored against your Behavior Spec using the same LLM-as-judge rubric y… | BLOCKED | ablation_judge.py:1, results/full-30-combined/judged_table.md:1, eval.py:37 | VERIFIED |
| SLM-R17 | A results table (mean Spec-adherence and Robustness per model × strate… | BLOCKED | results/full-30-combined/judged_table.md:3, results/full-30-combined/ANALYSIS.md:67 | VERIFIED |
...
| SLM-R35 | Completed Prompt-Ceiling Ablation report (see Required Ablations) — pr… | BLOCKED | results/full-30-combined/ANALYSIS.md:1, results/full-30-combined/ANALYSIS.md:67 | IMPLEMENTED-UNVERIFIED |
...
|---|---|---|---|
| SLM-R1 | PARTIAL | IMPLEMENTED-UNVERIFIED | results/full-30-combined/ANALYSIS.md:28, results/full-30-combined/ANALYSIS.md:57, results/full-30-combined/ANALYSIS.md:83 |
...
| SLM-R11 | PARTIAL | IMPLEMENTED-UNVERIFIED | results/full-30-combined/ANALYSIS.md:5, results/full-30-combined/ANALYSIS.md:28, results/full-30-combined/ANALYSIS.md:83 |
| SLM-R15 | PARTIAL | VERIFIED | metacog_precheck.py:287, results/full-30-combined/table.md:3 |
| SLM-R16 | MISSING | VERIFIED | ablation_judge.py:1, results/full-30-combined/judged_table.md:1, eval.py:37 |
| SLM-R17 | PARTIAL | VERIFIED | results/full-30-combined/judged_table.md:3, results/full-30-combined/ANALYSIS.md:67 |
...
| SLM-R35 | MISSING | IMPLEMENTED-UNVERIFIED | results/full-30-combined/ANALYSIS.md:1, results/full-30-combined/ANALYSIS.md:67 |
...
| `python3 ablation_judge.py --transcripts results/full-30-combined/transcripts.jsonl --scenarios metacog_scenari` | exit 0 — 180 judged; results/full-30-combined/judged_table.md, judge_transcripts.jsonl | SLM-R16, SLM-R17, SLM-R35 |
...
```
**SLM-R16** — `python3 ablation_judge.py --transcripts results/full-30-combined/transcripts.jsonl --scenarios metacog_scenarios.jsonl -`
```
...
```
**SLM-R17** — `python3 ablation_judge.py --transcripts results/full-30-combined/transcripts.jsonl --scenarios metacog_scenarios.jsonl -`
```
judging 180 conversations with claude-sonnet-4-6 (0 cached)
| sonnet | structured | 30 | 0.53 | 0.53 | 30 | 17/30 | 27/30 | ... |
| kimi | structured | 30 | 0.57 | 0.53 | 30 | 18/30 | 21/30 | ... |
